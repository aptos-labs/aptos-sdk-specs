...
> **BDD Framework:** XCTest (CucumberSwift has SPM compatibility issues)
...
CucumberSwift imports XCTest in its main library target, which causes compilation errors with
Swift Package Manager when building for non-test targets. This is a known limitation.
