...
fn given_module_address_and_name(world: &mut TestWorld, module_id: String) {
    world.named_values.insert("module_id".to_string(), module_id);
}
...
fn when_fetch_module_abi(world: &mut TestWorld) {
    ...
    world.named_values.insert("has_abi".to_string(), "true".to_string());
}
...
fn given_module_addresses(world: &mut TestWorld, addresses: String) {
    world.named_values.insert("module_addresses".to_string(), addresses);
}

#[when(expr = "I fetch ABIs for all modules")]
fn when_fetch_all_abis(world: &mut TestWorld) {
    world.named_values.insert("has_all_abis".to_string(), "true".to_string());
}

#[then(expr = "I should receive ABIs for each module")]
fn then_receive_all_abis(world: &mut TestWorld) {
    assert_eq!(world.named_values.get("has_all_abis"), Some(&"true".to_string()));
}

#[given(expr = "a non-existent module address")]
fn given_nonexistent_module(world: &mut TestWorld) {
    world.named_values.insert("module_id".to_string(), "0x999::nonexistent".to_string());
}
...
fn then_receive_not_found(world: &mut TestWorld) {
    assert!(world.error.as_ref().map(|e| e.contains("not found")).unwrap_or(false));
}
...
fn given_move_struct_def(world: &mut TestWorld) {
    world.named_values.insert("has_struct_def".to_string(), "true".to_string());
}
...
"#;
    ...
    world.named_values.insert("generated_language".to_string(), "rust".to_string());
}
...
fn given_entry_function(world: &mut TestWorld) {
    world.named_values.insert("function_type".to_string(), "entry".to_string());
}
...
fn then_get_typed_function(world: &mut TestWorld) {
    ...
    assert!(code.contains("fn ") || code.contains("async fn") || code.contains("function ") || code.contains("func "));
}
...
fn given_move_types(world: &mut TestWorld) {
    world.named_values.insert("has_move_types".to_string(), "true".to_string());
}
...
fn given_move_struct(world: &mut TestWorld, struct_name: String) {
    world.named_values.insert("struct_name".to_string(), struct_name);
}
...
"#;
    ...
    world.named_values.insert("generated_language".to_string(), "typescript".to_string());
}
...
fn given_entry_function_named(world: &mut TestWorld, func_name: String) {
    world.named_values.insert("function_name".to_string(), func_name);
    world.named_values.insert("function_type".to_string(), "entry".to_string());
}
...
fn then_params_have_types(world: &mut TestWorld) {
    ...
    assert!(code.contains(":") && (code.contains("string") || code.contains("AccountAddress") || code.contains("bigint") || code.contains("u64")));
}
...
fn given_view_function(world: &mut TestWorld, func_name: String) {
    world.named_values.insert("function_name".to_string(), func_name);
    world.named_values.insert("function_type".to_string(), "view".to_string());
}
...
"#;
    ...
    world.named_values.insert("generated_language".to_string(), "python".to_string());
}
...
"#;
    ...
    world.named_values.insert("generated_language".to_string(), "go".to_string());
}
...
fn given_cli_tool(world: &mut TestWorld) {
    world.named_values.insert("has_cli".to_string(), "true".to_string());
}

#[when(regex = r#"^I run "codegen --module 0x1::coin --output ./generated"$"#)]
fn when_run_codegen_cli(world: &mut TestWorld) {
    world.named_values.insert("cli_ran".to_string(), "true".to_string());
}
...
fn when_specify_typescript(world: &mut TestWorld) {
    world.named_values.insert("format".to_string(), "typescript".to_string());
}

#[then(expr = "it should generate TypeScript")]
fn then_generate_typescript(world: &mut TestWorld) {
    assert_eq!(world.named_values.get("format"), Some(&"typescript".to_string()));
}

#[when(regex = r#"^I specify "--format rust"$"#)]
fn when_specify_rust(world: &mut TestWorld) {
    world.named_values.insert("format".to_string(), "rust".to_string());
}
...
fn given_local_abi_file(world: &mut TestWorld) {
    world.named_values.insert("abi_source".to_string(), "local_file".to_string());
}
...
fn then_generate_from_file(world: &mut TestWorld) {
    assert_eq!(world.named_values.get("abi_source"), Some(&"local_file".to_string()));
}
...
fn given_function_with_constraints(world: &mut TestWorld) {
    world.named_values.insert("has_constraints".to_string(), "true".to_string());
}
...
fn given_module_with_docs(world: &mut TestWorld) {
    world.named_values.insert("has_docs".to_string(), "true".to_string());
}
