...
fn setup_valid_transaction(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
}
...
fn setup_simulation_state(world: &mut TestWorld) {
    if world.named_values.get("transaction_valid") == Some(&"true".to_string()) 
        ...
        world.named_values.insert("simulation_status".to_string(), "success".to_string());
        ...
        world.named_values.insert("simulation_success".to_string(), "false".to_string());
    }
}
...
fn given_unsigned_transaction(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("transaction_signed".to_string(), "false".to_string());
}
...
fn when_inspect_simulation_result(world: &mut TestWorld) {
    ...
    world.named_values.insert("state_changes".to_string(), "[balance_change]".to_string());
...
fn given_complex_transaction(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("transaction_complexity".to_string(), "complex".to_string());
}
...
fn when_simulate_different_gas(world: &mut TestWorld) {
    ...
    world.named_values.insert("min_gas_needed".to_string(), "5000".to_string());
}
...
fn given_transfer_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("tx_type".to_string(), "transfer".to_string());
}

#[then(expr = "I should see sender balance decrease")]
fn then_sender_balance_decrease(world: &mut TestWorld) {
    world.named_values.insert("sender_balance_change".to_string(), "-1000".to_string());
...
fn then_recipient_balance_increase(world: &mut TestWorld) {
    world.named_values.insert("recipient_balance_change".to_string(), "+1000".to_string());
...
fn given_resource_modifying_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("modifies_resources".to_string(), "true".to_string());
}

#[then(expr = "I should see which resources change")]
fn then_see_resource_changes(world: &mut TestWorld) {
    world.named_values.insert("resource_changes".to_string(), "[CoinStore]".to_string());
...
fn then_see_new_values(world: &mut TestWorld) {
    world.named_values.insert("new_values".to_string(), "{coin: 1000}".to_string());
...
fn given_aborting_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("will_abort".to_string(), "true".to_string());
    world.named_values.insert("abort_code".to_string(), "65537".to_string());
...
fn given_exceeding_balance_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("insufficient_balance".to_string(), "true".to_string());
}
...
fn then_indicate_insufficient_funds(world: &mut TestWorld) {
    world.named_values.insert("failure_reason".to_string(), "INSUFFICIENT_BALANCE".to_string());
...
fn given_wrong_type_args_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("type_error".to_string(), "true".to_string());
}

#[then(expr = "indicate the type mismatch")]
fn then_indicate_type_mismatch(world: &mut TestWorld) {
    world.named_values.insert("failure_reason".to_string(), "TYPE_MISMATCH".to_string());
    assert!(world.named_values.contains_key("failure_reason"));
}
...
fn given_nonexistent_resource_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("resource_not_found".to_string(), "true".to_string());
}

#[then(expr = "indicate resource not found")]
fn then_indicate_resource_not_found(world: &mut TestWorld) {
    world.named_values.insert("failure_reason".to_string(), "RESOURCE_NOT_FOUND".to_string());
    assert!(world.named_values.contains_key("failure_reason"));
}
...
fn given_historical_version(world: &mut TestWorld) {
    world.named_values.insert("ledger_version".to_string(), "12345678".to_string());
}

#[when(expr = "I simulate at that version")]
fn when_simulate_at_version(world: &mut TestWorld) {
    world.named_values.insert("simulation_version".to_string(), 
        world.named_values.get("ledger_version").cloned().unwrap_or_default());
    world.named_values.insert("simulation_success".to_string(), "true".to_string());
}
...
fn when_simulate_with_max_gas(world: &mut TestWorld) {
    world.named_values.insert("max_gas_override".to_string(), "50000".to_string());
    world.named_values.insert("simulation_success".to_string(), "true".to_string());
}
...
fn when_simulate_with_gas_price(world: &mut TestWorld) {
    world.named_values.insert("gas_price_override".to_string(), "100".to_string());
    world.named_values.insert("simulation_success".to_string(), "true".to_string());
}
...
fn given_multi_agent_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("tx_type".to_string(), "multi_agent".to_string());
}

#[then(expr = "show changes for all involved accounts")]
fn then_show_all_account_changes(world: &mut TestWorld) {
    world.named_values.insert("primary_account_changes".to_string(), "true".to_string());
    world.named_values.insert("secondary_account_changes".to_string(), "true".to_string());
...
fn given_fee_payer_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_valid".to_string(), "true".to_string());
    world.named_values.insert("tx_type".to_string(), "fee_payer".to_string());
}

#[then(expr = "gas should be charged to fee payer")]
fn then_gas_charged_to_fee_payer(world: &mut TestWorld) {
    world.named_values.insert("fee_payer_charged".to_string(), "true".to_string());
    assert_eq!(world.named_values.get("fee_payer_charged"), Some(&"true".to_string()));
}
...
fn given_state_changes_between(world: &mut TestWorld) {
    world.named_values.insert("state_changed_between".to_string(), "true".to_string());
}

#[when(expr = "I submit after simulation")]
fn when_submit_after_simulation(world: &mut TestWorld) {
    world.named_values.insert("submitted".to_string(), "true".to_string());
}

#[then(expr = "results might differ")]
fn then_results_might_differ(world: &mut TestWorld) {
    assert_eq!(world.named_values.get("state_changed_between"), Some(&"true".to_string()));
}
...
fn given_current_sequence_number(world: &mut TestWorld, seq_num: u64) {
    world.named_values.insert("current_sequence_number".to_string(), seq_num.to_string());
}

#[when(regex = r"^I simulate transaction with seq num (\d+)$")]
fn when_simulate_with_seq_num(world: &mut TestWorld, seq_num: u64) {
    world.named_values.insert("tx_sequence_number".to_string(), seq_num.to_string());
    world.named_values.insert("simulation_success".to_string(), "true".to_string());
}
...
fn given_multiple_transactions(world: &mut TestWorld) {
    world.named_values.insert("tx_count".to_string(), "3".to_string());
}

#[when(expr = "I simulate them in batch")]
fn when_simulate_batch(world: &mut TestWorld) {
    world.named_values.insert("batch_simulation".to_string(), "true".to_string());
    world.named_values.insert("batch_results".to_string(), "3".to_string());
}
...
fn given_sequential_seq_nums(world: &mut TestWorld) {
    world.named_values.insert("tx_seq_nums".to_string(), "5,6,7".to_string());
}

#[when(expr = "I simulate them in order")]
fn when_simulate_in_order(world: &mut TestWorld) {
    world.named_values.insert("simulated_in_order".to_string(), "true".to_string());
}

#[then(expr = "later simulations should see earlier changes")]
fn then_see_earlier_changes(world: &mut TestWorld) {
    assert_eq!(world.named_values.get("simulated_in_order"), Some(&"true".to_string()));
}
...
fn given_api_unavailable(world: &mut TestWorld) {
    world.named_values.insert("api_unavailable".to_string(), "true".to_string());
}
...
fn given_malformed_tx(world: &mut TestWorld) {
    world.named_values.insert("transaction_malformed".to_string(), "true".to_string());
}
...
fn given_very_complex_tx(world: &mut TestWorld) {
    world.named_values.insert("has_transaction".to_string(), "true".to_string());
    world.named_values.insert("transaction_complexity".to_string(), "very_complex".to_string());
}

#[when(expr = "simulation takes too long")]
fn when_simulation_timeout(world: &mut TestWorld) {
    world.error = Some("Timeout: simulation exceeded time limit. Try increasing timeout.".to_string());
}
...
fn given_signed_tx_for_submission(world: &mut TestWorld) {
    world.named_values.insert("signed_tx".to_string(), "true".to_string());
    world.named_values.insert("has_authenticator".to_string(), "true".to_string());
}
...
fn when_get_authenticator(world: &mut TestWorld) {
    if world.named_values.get("has_authenticator") == Some(&"true".to_string()) {
        world.named_values.insert("authenticator_retrieved".to_string(), "true".to_string());
        world.named_values.insert("authenticator_type".to_string(), "Ed25519".to_string());
    }
}
