...
fn when_create_mainnet_indexer(world: &mut TestWorld) {
    ...
    world
        .named_values
        .insert("has_indexer_client".to_string(), "true".to_string());
}
...
fn when_execute_query(world: &mut TestWorld) {
    ...
    if world.named_values.get("invalid_query") == Some(&"true".to_string()) {
        ...
        world
            .named_values
            .insert("query_executed".to_string(), "true".to_string());
        world
            .named_values
            .insert("query_result".to_string(), "{ \"data\": {} }".to_string());
    }
}
...
fn when_execute_with_variables(world: &mut TestWorld) {
    ...
    world
        .named_values
        .insert("variables_substituted".to_string(), "true".to_string());
    world
        .named_values
        .insert("query_result".to_string(), "{ \"data\": {} }".to_string());
}
...
fn then_variables_substituted(world: &mut TestWorld) {
    assert_eq!(
        world.named_values.get("variables_substituted"),
        Some(&"true".to_string())
    );
}
...
fn given_invalid_query(world: &mut TestWorld) {
    world
        .named_values
        .insert("graphql_query".to_string(), "{ invalid_syntax".to_string());
    world
        .named_values
        .insert("invalid_query".to_string(), "true".to_string());
}
...
fn given_account_with_nfts(world: &mut TestWorld) {
    ...
    world
        .named_values
        .insert("has_nfts".to_string(), "true".to_string());
}
...
fn when_query_current_tokens(world: &mut TestWorld) {
    world
        .named_values
        .insert("tokens_queried".to_string(), "true".to_string());
    world.named_values.insert(
...
fn given_account_many_nfts(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xmany_nfts".to_string());
    world
        .named_values
        .insert("nft_count".to_string(), "50".to_string());
}
...
fn when_query_tokens_paginated(world: &mut TestWorld, limit: u32, offset: u32) {
    world
        .named_values
        .insert("query_limit".to_string(), limit.to_string());
    world
        .named_values
        .insert("query_offset".to_string(), offset.to_string());
    world.named_values.insert(
        "token_list".to_string(),
...
fn given_account_with_nft(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xnft_holder".to_string());
    world
        .named_values
        .insert("token_name".to_string(), "Test Token #1".to_string());
    world
        .named_values
        .insert("collection_name".to_string(), "Test Collection".to_string());
    world.named_values.insert(
        "token_uri".to_string(),
        "https://example.com/token/1".to_string(),
    );
    world
        .named_values
        .insert("token_amount".to_string(), "1".to_string());
}
...
fn when_query_token(world: &mut TestWorld) {
    world
        .named_values
        .insert("token_queried".to_string(), "true".to_string());
}
...
fn given_account_no_nfts(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xno_nfts".to_string());
    world
        .named_values
        .insert("has_nfts".to_string(), "false".to_string());
}
...
fn when_query_tokens(world: &mut TestWorld) {
    if world.named_values.get("has_nfts") == Some(&"false".to_string()) {
        world
            .named_values
            .insert("token_list".to_string(), "[]".to_string());
    } else {
        world
            .named_values
            .insert("token_list".to_string(), "[...]".to_string());
...
fn given_account_with_apt(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xapt_holder".to_string());
    world
        .named_values
        .insert("apt_balance".to_string(), "1000000000".to_string());
}

#[when(expr = "I query APT fungible asset balance")]
fn when_query_apt_balance(world: &mut TestWorld) {
    world.named_values.insert(
        "queried_balance".to_string(),
        world
            .named_values
            .get("apt_balance")
            .cloned()
...
fn given_fungible_query(world: &mut TestWorld) {
    world
        .named_values
        .insert("asset_name".to_string(), "Aptos Coin".to_string());
    world
        .named_values
        .insert("asset_symbol".to_string(), "APT".to_string());
    world
        .named_values
        .insert("asset_decimals".to_string(), "8".to_string());
}
...
fn when_request_metadata(world: &mut TestWorld) {
    world
        .named_values
        .insert("metadata_queried".to_string(), "true".to_string());
}
...
fn given_account_tx_history(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xtx_history".to_string());
    world
        .named_values
        .insert("has_tx_history".to_string(), "true".to_string());
}
...
fn given_account_many_txs(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xmany_txs".to_string());
    world
        .named_values
        .insert("tx_count".to_string(), "100".to_string());
}
...
fn given_account_tx(world: &mut TestWorld) {
    world
        .named_values
        .insert("tx_version".to_string(), "12345".to_string());
    world
        .named_values
        .insert("tx_hash".to_string(), "0xabcdef".to_string());
    world
        .named_values
        .insert("tx_sender".to_string(), "0x1".to_string());
    world
        .named_values
        .insert("tx_success".to_string(), "true".to_string());
    world
        .named_values
        .insert("tx_timestamp".to_string(), "1234567890".to_string());
}
...
fn when_query_from_indexer(world: &mut TestWorld) {
    world
        .named_values
        .insert("tx_queried".to_string(), "true".to_string());
}
...
fn given_various_tx_types(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xvarious_txs".to_string());
    world.named_values.insert(
        "tx_types".to_string(),
        "user,genesis,block_metadata".to_string(),
    );
}
...
fn when_query_user_txs(world: &mut TestWorld) {
    world
        .named_values
        .insert("tx_filter".to_string(), "user".to_string());
    world
        .named_values
        .insert("filtered_txs".to_string(), "user_only".to_string());
}

#[then(expr = "I should only receive user transactions")]
fn then_only_user_txs(world: &mut TestWorld) {
    assert_eq!(
        world.named_values.get("filtered_txs"),
        Some(&"user_only".to_string())
    );
}
...
fn given_collection_address(world: &mut TestWorld) {
    world.named_values.insert(
        ...
        "0xcollection123".to_string(),
    );
    world
        .named_values
        .insert("collection_name".to_string(), "My Collection".to_string());
    world
        .named_values
        .insert("creator_address".to_string(), "0xcreator".to_string());
    world
        .named_values
        .insert("current_supply".to_string(), "100".to_string());
}
...
fn when_query_collection(world: &mut TestWorld) {
    world
        .named_values
        .insert("collection_queried".to_string(), "true".to_string());
}
...
fn given_account_coin_balances(world: &mut TestWorld) {
    world
        .named_values
        .insert("account_address".to_string(), "0xcoin_holder".to_string());
    world.named_values.insert(
        "coin_balances".to_string(),
...
fn when_query_coin_balances(world: &mut TestWorld) {
    world
        .named_values
        .insert("coin_balances_queried".to_string(), "true".to_string());
}
...
fn when_query_processor_status(world: &mut TestWorld) {
    world
        .named_values
        .insert("processor_version".to_string(), "12345678".to_string());
}
...
fn given_processor_status(world: &mut TestWorld) {
    world
        .named_values
        .insert("processor_version".to_string(), "12345000".to_string());
}
...
fn when_compare_versions(world: &mut TestWorld) {
    ...
    world
        .named_values
        .insert("indexer_lag".to_string(), lag.to_string());
}
...
fn given_unreachable_indexer(world: &mut TestWorld) {
    world
        .named_values
        .insert("indexer_unreachable".to_string(), "true".to_string());
}
...
fn given_complex_query(world: &mut TestWorld) {
    world
        .named_values
        .insert("complex_query".to_string(), "true".to_string());
}
...
fn given_short_timeout(world: &mut TestWorld) {
    world
        .named_values
        .insert("timeout_short".to_string(), "true".to_string());
}
...
fn given_unexpected_format(world: &mut TestWorld) {
    world
        .named_values
        .insert("unexpected_format".to_string(), "true".to_string());
}
