...
> Scope: All SDK test implementations (TypeScript, Go, Rust, Python, .NET, Kotlin)
...
- Replace "Validation placeholder" no-ops with real assertions in error, multi-agent, transaction builder, serialization, and signing steps
