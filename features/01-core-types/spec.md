...
Core types are the fundamental data structures used throughout an Aptos SDK. They provide type-safe representations of blockchain primitives including addresses, hashes, chain identifiers, and Move type representations.
