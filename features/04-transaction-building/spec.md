...
The transaction building module provides types and utilities for constructing, signing, and
serializing Aptos transactions. It supports various transaction types including entry functions,
scripts, and advanced transaction modes.
